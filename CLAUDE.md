...
**The current shooter version is: `0.2.24`**

**Format:**
```
**`sho:<name>`** · **shooter v0.2.24** · model: **<model>**
```

- `<name>` — the command name (e.g., `prj-setup-infrastructure`, `gtd-epic-plan`, `cfg-make-healthy`)
- `shooter v0.2.24` — the shooter framework version (compiled into this file, do NOT read `.shooter/VERSION` for banners)
...
```markdown
## Banner
Output: **`sho:<command-name>`** · **shooter v0.2.24** · model: **<model>**
```
...
| `sho:prj-show-progress` | None | Read-only dashboard | No mitigation needed |
