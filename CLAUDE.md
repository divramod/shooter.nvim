...
@.ai-rules/rules/core/coding-standards.md
@.ai-rules/rules/core/security.md
@.ai-rules/rules/core/commit-conventions.md
@.ai-rules/rules/core/multi-agent-conventions.md

@.ai-rules/commands/review.md
@.ai-rules/commands/refactor.md
@.ai-rules/commands/test.md
@.ai-rules/commands/debug.md
# --- shared-ai-rules-end ---
