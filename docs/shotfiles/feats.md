...
it should list the docs/shotfiles/docs/plans to open them

## x shot 32 < >pe (2026-04-26 08:59:57)
please map < >pe also to < >e

## x shot 31 improve < >pf command (2026-04-26 08:29:15)
i want to add a new category in the masterplan file.
currently we have 
1. in progress
2. next plans
3. backlog
...
i want to add planned in between in progress and next plans, so that i have the following categories in the masterplan file
1. in progress
2. planned
3. next plans
4. backlog
...
please analyze deeply, go into plan mode and implement it
