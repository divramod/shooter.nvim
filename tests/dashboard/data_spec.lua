...
describe('dashboard.data module', function()
  ...
  before_each(function()
    ...
    vim.fn.mkdir(test_dir .. '/.shooter/project-shotfiles', 'p')
  end)
  ...
  describe('get_open_shots', function()
    it('finds open shots in a file', function()
      test_file = test_dir .. '/.shooter/project-shotfiles/test.md'
...
Content here
    ...
    it('excludes files with no open shots', function()
      ...
      test_file = test_dir .. '/.shooter/project-shotfiles/done.md'
      local f = io.open(test_file, 'w')
