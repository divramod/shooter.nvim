...
describe('history module', function()
  ...
  describe('build_history_path', function()
    it('builds correct path with timestamp', function()
      local filepath, dirpath = history.build_history_path('user', 'repo', 'test.md', 42, '20260121_143000')
      assert.is_truthy(filepath:match('user/repo/test/shot%-0042%-20260121_143000%.md$'))
      assert.is_truthy(dirpath:match('user/repo/test$'))
    end)
