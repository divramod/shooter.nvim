...
**The current shooter version is: `0.2.6`**

**Format:**
```
**`sho:<name>`** · **shooter v0.2.6** · model: **<model>**
```

- `<name>` — the command name (e.g., `prj-setup-infrastructure`, `gtd-epic-plan`, `cfg-make-healthy`)
- `shooter v0.2.6` — the shooter framework version (compiled into this file, do NOT read `.shooter/VERSION` for banners)
...
```markdown
## Banner
Output: **`sho:<command-name>`** · **shooter v0.2.6** · model: **<model>**
```
