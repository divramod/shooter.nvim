...
Source: mod/ai v0.1.0 | Generated: 2026-01-30
...
> Auto-generated by GSD `map-codebase`. See `.planning/codebase/` for details.
...
- Capture the fix with `/gsd:add-todo` for follow-up testing
...
- If stuck after 30 minutes, capture findings with `/gsd:add-todo` and move on
