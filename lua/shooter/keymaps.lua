...
function M.setup()
  ...
  map('n', 'fcf', ':ShooterFileToggleFirstShotOfDayColoring<cr>', 'Toggle day markers')
  ...
  map('n', 'sD', ':ShooterShotDeleteCursor<cr>', 'Delete shot at cursor')
  ...
  map('n', 'sC', ':ShooterShotCreateFromClaude<cr>', 'Create shot from Claude')
