...
local function get_prompt_files()
  ...
  local prompts_dir = cwd .. '/.shooter/project-shotfiles'
...
function M.move_file(pb, tfolder)
  ...
  local tdir = tfolder == '' and cwd .. '/.shooter/project-shotfiles' or cwd .. '/.shooter/project-shotfiles/' .. tfolder
  local tpath = tdir .. '/' .. fname
  local dname = tfolder == '' and 'prompts' or tfolder

  vim.fn.mkdir(tdir, 'p')
  if tfolder == '' and vim.fn.fnamemodify(src, ':h') == cwd .. '/.shooter/project-shotfiles' then
