...
TOOLS NAMESPACE (l prefix)
  ...
  lc        Clipboard paste       Paste clipboard image to .hal/util/shooter/tmp/image-pastes/
...
FOLDER STRUCTURE
  .hal/util/shooter/shotfiles/           <- new files created here (in-progress)
...
SMART PASTE (global keymaps, disable with keymaps.smart_paste = false)
  ...
  Images saved to: <repo>/.hal/util/shooter/tmp/image-pastes/clipboard_YYYYMMDD_HHMMSS.png
