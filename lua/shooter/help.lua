...
QUICK FOLDER ACCESS (, prefix)
  ,p        Prompts folder        Open .shooter/project-shotfiles in Oil
...
FOLDER STRUCTURE
  .shooter/project-shotfiles/           <- new files created here (in-progress)
  .shooter/project-shotfiles/archive/   <- completed/archived
  .shooter/project-shotfiles/backlog/   <- future tasks
  .shooter/project-shotfiles/done/      <- finished tasks
  .shooter/project-shotfiles/reqs/      <- requirements
  .shooter/project-shotfiles/test/      <- testing
  .shooter/project-shotfiles/wait/      <- waiting/blocked
...
PROJECT SUPPORT
  ...
  - Files are created at projects/<name>/.shooter/project-shotfiles/
