...
3. Add as a theme in the **current project's** `.shooter/project-themes.json`
...
```json
{ "slug": "<short-name>", "title": "<project>/<short-name>", "path": "<relative-path-to-fork>", "shotfile": ".shooter/project-shotfiles/<short-name>.md" }
```
